...
- **Save selection as a new file** — write the selected node (or whole model) with its current transforms and poses to GLB / glTF / OBJ / STL / PLY / USDZ, defaulting to the source format when three.js can write it
